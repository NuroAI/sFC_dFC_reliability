...
for windowsize=40:10:70
    ...
    sn=strcat('dynamic_820_despike_slidingwindow_bandpass_highpass_win',num2str(windowsize,'%03d') ,'_leonardi2015.mat');
...
static_fc=static_fc(sw_d4,[3,2,1]);

sn=strcat('static_fc_820_DOS160_bandpass_0.01_0.1_despike.mat');
%     save(sn,'sw_d1','sw_d2','sw_d3','sw_d4');
save(sn,'static_fc')
%     save(sn,'sw_d2');
